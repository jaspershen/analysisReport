...
<h4> <p style="line-height:1.5em;">**MetDNA (version 0.99.16)**: Created in 2018 by Xiaotao Shen, Xin Xiong and Ruohong Wang from Dr. Zheng-Jiang Zhu lab, Chinese Academy of Sciences.</p> </h4>
...
<img src = "peak.distribution.plot.png" class = "img-topic" width = "1200", align = "middle" alt = "Figure 1: Peak distribution">
...
<img src = "annotation.information.and.redundancy.removal.in.metABM.POS.png" class = "img-topic" width = "1200", align = "middle">

<center>![](annotation.information.and.redundancy.removal.in.metABM.POS.png)</center>

#### **Figure 2: The number of identified metabolites and cumulative identified metabolites (left panel) and peak and metabolite redundancy (right panel). (Positive mode)**

<img src = "annotation.information.and.redundancy.removal.in.metABM.NEG.png" class = "img-topic" width = "1200", align = "middle">

<center>![](annotation.information.and.redundancy.removal.in.metABM.NEG.png)</center>

#### **Figure 3: The number of identified metabolites and cumulative identified metabolites (left panel) and peak and metabolite redundancy (right panel). (Negative mode)**


<img src = "annotation.grade.POS.png" class = "img-topic" width = "1200", align = "middle">

#### **Figure 4: The confidence levles of identified metabolites. (Positive mode)**

<center>![](annotation.grade.POS.png)</center>

<img src = "annotation.grade.NEG.png" class = "img-topic" width = "1200", align = "middle">
...
#### **Figure 6: Volcano plot (left panel) and summary of dysregulated pathways (right panel).**
